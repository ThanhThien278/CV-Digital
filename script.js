...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const animatedElements = document.querySelectorAll('.education-item, .skill-category, .about-stats .stat');
...
document.getElementById('download-cv').addEventListener('click', (e) => {
    e.preventDefault();
    showNotification('Tính năng tải CV sẽ được cập nhật sớm!', 'info');
});
